...
DIR_CATALOGUES_LIGHTCURVES_GROUPED_TEMP = DIR_CATALOGUES_LIGHTCURVES_GROUPED + 'temp/'
DIR_CATALOGUES_LIGHTCURVES_GROUPED_TEMP_TRANSIENTS = DIR_CATALOGUES_LIGHTCURVES_GROUPED_TEMP + 'transients/'
DIR_CATALOGUES_LIGHTCURVES_GROUPED_TEMP_OBJECTS = DIR_CATALOGUES_LIGHTCURVES_GROUPED_TEMP + 'objects/'

DIR_IMAGES = DIR_DATA + 'images/'
DIR_IMAGES_CURVES = DIR_IMAGES + 'curves/'
DIR_IMAGES_SCATTERS = DIR_IMAGES + 'scatters/'
